      ...
      >
        <div className="p-6 sm:p-8">
          ...
          <p className="text-gray-300 text-center mb-6">
            Sua compra foi cancelada. Nenhuma cobrança foi realizada.
          </p>
          <div className="bg-gray-700 rounded-lg p-4 mb-6">
            <p className="text-sm text-gray-400 text-center">
              Se você encontrou qualquer problema durante o processo de compra,
              por favor fale com nosso time de suporte.
            </p>
          </div>
